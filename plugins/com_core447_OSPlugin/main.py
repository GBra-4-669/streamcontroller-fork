...
from .actions.SmartCommand.SmartCommand import SmartCommand
...
class OSPlugin(PluginBase):
    def __init__(self):
        ...
        self.smart_command_holder = ActionHolder(
            plugin_base=self,
            action_base=SmartCommand,
            action_id_suffix="SmartCommand",
            action_name="Smart Command",
            action_support={
        ...
        self.add_action_holder(self.smart_command_holder)
